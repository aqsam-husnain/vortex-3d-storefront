...
interface PageDocumentData {
   ...
   * - **Tab**: Main
   * - **Documentation**: https://docs/field#rich-text-title
   */
   ...
   * - **Tab**: Main
   * - **Documentation**: https://docs/field#slices
   */
   ...
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://docs/field#key-text
   */;
   ...
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://docs/field#image
   */
 ...
 * - **API ID**: `page`
 * - **Repeatable**: `true`
 * - **Documentation**: https://docs/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type PageDocument<Lang extends string = string> =
  prismic.DocumentWithUID<Simplify<PageDocumentData>, "page", Lang>;
...
export interface AlternatingTextSliceDefaultPrimary {
   ...
   * - **Documentation**: https://docs/field#group
   */
 ...
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://docs/slice
 */
...
export interface HeroSliceDefaultPrimary {
   ...
   * - **Documentation**: https://docs/field#link-content-relationship
   */
...
export interface SkyDiveSliceDefaultPrimary {
   ...
   * - **Documentation**: https://docs/field#select
   */
